  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center gap-12">
        <div ref={textRef} className="md:w-1/2 text-lg leading-relaxed">
          <p className="mb-4">
        ...
        <div ref={imageRef} className="md:w-1/2 flex justify-center">
          <img
            src="https://placehold.co/400x400/2d3748/e2e8f0?text=Your+Photo"
            alt="Jane Doe"
            className="rounded-full shadow-xl object-cover w-64 h-64 md:w-80 md:h-80 border-4 border-accent"
          />
        </div>
      </div>
    </section>
