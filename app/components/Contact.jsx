...
const Contact = () => {
  ...
  if (state.succeeded) {
    return (
      ...
      >
        ...
        <p className="text-2xl font-semibold text-[var(--color-accent-neon-blue)]">
          Thanks for your message! I'll get back to you soon.
        </p>
        <p className="text-[var(--color-secondary-text)] mt-4">
  ...
  return (
    ...
    >
      <h2 className="text-4xl font-bold text-center text-[var(--color-accent-neon-blue)] mb-12">
        Take A
        <span className="text-[var(--color-accent-orange)]"> Coffee </span>
        And
        <span className="text-[var(--color-accent-orange)]"> Chat </span>
        With Me
      </h2>
